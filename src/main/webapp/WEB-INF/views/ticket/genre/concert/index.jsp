...
<%
  // header.jsp에서 현재 메뉴 하이라이트 처리용
  request.setAttribute("activeNav", "concert");
%>
<!doctype html>
<html lang="ko">
  <head>
    ...
    <!-- 기존 디자인 톤/컴포넌트(헤더/푸터/포스터 카드 등) 재사용 -->
        ...
        <div class="container">
                  ...
                  <article class="carousel__item banner-card">
                    <a class="poster" href="${pageContext.request.contextPath}/performance/detail?id=<%=100+i%>" aria-label="배너 <%=i%>">
                      ...
                      <span class="poster__overlay">
                        ...
                        <span class="poster__meta">2026.01.0<%= (i % 9) + 1 %> - 2026.02.0<%= (i % 9) + 1 %> · 공연장(예시)</span>
                      </span>
                    </a>
                  </article>
                  <%
          ...
          <section class="work-grid" aria-label="콘서트 목록">
            ...
            <article class="work-card">
              <a class="poster work-card__poster" href="${pageContext.request.contextPath}/performance/detail?id=1" aria-label="작품 상세">
                <img class="poster__img" src="${pageContext.request.contextPath}/assets/img/poster-placeholder.svg" alt="포스터" />
            ...
            <article class="work-card">
              ...
              <div class="work-card__title">콘서트 작품명(예시) <%=i%></div>
              <div class="work-card__meta">
