<%@ page contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
  <% request.setAttribute("activeNav", "" ); String q=request.getParameter("q"); if (q==null) q="" ; %>
    <!doctype html>
    <html lang="ko">
    ...
    <head>
      ...
      <%@ include file="../inc/head_link.jsp" %>
        ...
        <link rel="stylesheet" href="/static/assets/css/search.css?v=dev4" />
    </head>
          ...
          -->
              <section class="search-grid" aria-label="티켓 검색 결과 목록">
                <article class="search-card">
                  <a class="poster search-card__poster" href="/performance/detail?id=1" aria-label="작품 상세">
                ...
                <article class="search-card">
                  <a class="poster search-card__poster" href="/performance/detail?id=2" aria-label="작품 상세">
                    <img class="poster__img" src="/static/assets/img/poster-placeholder.svg" alt="포스터" />
                  </a>
                  <div class="search-card__body">
