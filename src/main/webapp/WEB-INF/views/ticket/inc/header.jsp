<%@ page contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
  ...
  <% String activeNav=(String) request.getAttribute("activeNav"); if (activeNav==null) activeNav="" ; %>
          ...
          <form class="search" action="/search" method="get" role="search">
            ...
            <button class="search__btn" type="submit" aria-label="검색">
              <svg width="20" height="20" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
                <path
               	 	d="M10.5 3a7.5 7.5 0 1 0 4.67 13.37l4.23 4.23a1 1 0 0 0 1.42-1.42l-4.23-4.23A7.5 7.5 0 0 0 10.5 3Zm0 2a5.5 5.5 0 1 1 0 11 5.5 5.5 0 0 1 0-11Z"
                  fill="currentColor" />
              </svg>
            </button>
          </form>
